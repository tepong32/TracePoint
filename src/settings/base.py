"""
Shared Django settings for all TracePoint environments.
"""
...
if os.getenv('DJANGO_ENV', 'development').lower() == 'production' and SECRET_KEY == 'django-insecure-dev-only-secret-key':
